...
public class MessageController {
    ...
    public ResponseEntity<Message> createDraft(
        ...
        return ResponseEntity.ok(
            messageService.createDraft(ownerId, trusteeId, subject, body)
        );
    }
    ...
    public ResponseEntity<List<Message>> getMessagesByOwner(
            @PathVariable UUID ownerId) {
        return ResponseEntity.ok(
            messageService.getMessagesByOwner(ownerId)
        );
    }
