...
public class DigitalAssetService {
  ...
  public DigitalAsset createAsset(
      UUID ownerId, String name, String description, AssetType type, MultipartFile file)
      throws IOException {
  ...
  public void deleteAsset(UUID assetId, UUID ownerId) throws IOException {
    DigitalAsset asset = assetRepo.findByIdAndLegacyOwnerId(assetId, ownerId).orElseThrow();
